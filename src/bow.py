...
limit = 1000
random = True
reviews_list = utils.getReviews(limit=1000, random=True)
...
for i, review in enumerate(reviews):
    ...
    stemmed_text = utils.stemDocument(tokenized_text)
    if (utils.stemWord("beauty") in stemmed_text):
